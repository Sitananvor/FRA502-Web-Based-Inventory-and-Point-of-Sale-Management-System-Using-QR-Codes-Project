...
function InventoryBatch() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      alert("Failed to load item data. Please check your connection and try again.");
    } finally {
      setIsLoading(false);
    }
  }, [productId]);
  ...
  const displayProductName = firstBatch.products?.name || "Not Available Product";
    ...
    <div className="page">
      ...
      <div className="layout">
        <div className="top-layout">
          ...
          <Button label="Add Batch" style={{ padding: "12px 24px" }} className="add-button" onClick={() => setIsAddModalOpen(true)} />
